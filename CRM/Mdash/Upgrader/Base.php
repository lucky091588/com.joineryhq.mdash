 ...
 */
class CRM_Mdash_Upgrader_Base {

  /**
   * @var CRM_Mdash_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Mdash_Upgrader(
        'com.joineryhq.mdash',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Mdash_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Mdash_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
